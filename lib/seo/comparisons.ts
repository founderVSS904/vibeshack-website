...
export const comparisons = [
  ...
  },
  {
    ...
    title: 'Photography Studio vs Location Shoot',
    ...
    sections: [
      ...
      { heading: 'Campaigns often need both', body: 'Shoot hero portraits, products, and clean social crops in studio, then add a smaller set of location images for context.' },
    ],
    faqs: [
      { question: 'Is a studio better for product photography?', answer: 'Usually yes. Products benefit from controlled lighting, clean surfaces, repeatable angles, and fewer interruptions.' },
      { question: 'Can I shoot campaign photos and video in one studio booking?', answer: 'Yes. Plan the shot list around lighting setups so photo and video assets can be captured efficiently.' },
    ],
  },
]
