...
export const metadata: Metadata = {
  ...
  description: "Book podcast, green screen, room-only photo/video, and white cyc studios in San Francisco. Rentals from $100/hr; contact us for production.",
  alternates: { canonical: 'https://www.vibeshackstudios.com/' },
  openGraph: {
    title: "VibeShack Studios | San Francisco Production Studio",
    description: "Podcast, green screen, room-only photo/video, and white cyc studios in SF. Rentals from $100/hr; contact us for production.",
...
const serviceHighlights = [
  {
    ...
    kicker: 'Portraits, products, campaigns',
    description: 'Scoped photoshoots for headshots, founder portraits, product images, press photos, lookbooks, and campaign stills.',
    price: 'Contact us',
    image: '/studio-images/enhanced-photography-cyc-fashion-black-curtain-v20260510.jpg',
    alt: 'Editorial fashion photography shot at VibeShack Studios San Francisco',
  },
  {
    href: '/video-production/',
    label: 'Video Production',
    kicker: 'Interviews, social, brand content',
    description: 'Production-ready rooms for founder videos, product demos, short-form ads, talking heads, green screen, and content days.',
    price: 'Contact us',
  ...
  },
  {
    ...
    kicker: 'Cameras, microphones, crew options',
    description: 'Book a room built for conversation with broadcast microphones, multi-camera setups, and same-day footage delivery.',
    price: '$300-$400/hr',
...
export default function HomePage() {
  return (
    <>
      ...
      ═══════════════════════════════════════════ */}
      <section className="relative min-h-[74svh] sm:min-h-[78svh] md:min-h-[82vh] lg:min-h-[84vh] flex items-start justify-start overflow-hidden bg-black pt-24 md:items-center md:pt-0">
        <WebGLShader />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          {/* Location tag */}
          <div>
            <div className="flex items-center gap-3 mb-6 min-w-0 sm:mb-10">
              <span className="block sm:hidden text-gray-400 text-[10px] tracking-[0.22em] uppercase font-medium leading-relaxed">
                San Francisco · Open 24/7
              </span>
              <span className="hidden sm:block text-gray-400 text-xs tracking-[0.3em] uppercase font-medium leading-relaxed">
                San Francisco · Northern Waterfront · Open 24/7
              </span>
            </div>
          </div>
          ...
          {/* Main headline */}
          <div>
            <h1 className="mb-8 max-w-4xl sm:mb-12">
      ...
      {/* ═══ STUDIO GRID ═══ */}
      <section className="bg-black pb-3 pt-40 sm:py-3">
        <div className="max-w-7xl mx-auto px-3">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4" data-stagger>
            {[
              ...
              { src: '/studio-images/premier-wide-v1775084326.jpg', label: 'Premier', href: '/premier/', alt: 'Premier — Luxury podcast and interview studio — VibeShack Studios SF' },
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-12">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-md">
              Start with what you&apos;re making: photoshoots, brand videos, podcasts, or flexible studio rentals, all under one San Francisco roof.
            </p>
          </div>
