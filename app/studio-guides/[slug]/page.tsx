    ...
    <>
      ...
      <section className="bg-black px-6 py-24 sm:px-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 lg:grid-cols-[0.74fr_1fr]">
          <div>
            <p className="text-[11px] font-bold uppercase text-brand-red">Producer read</p>
      ...
      <section className="border-y border-white/10 bg-zinc-950 px-6 py-24 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 max-w-3xl">
            <p className="text-[11px] font-bold uppercase text-brand-red">Decision sequence</p>
      ...
      <section className="bg-black px-6 py-24 sm:px-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 lg:grid-cols-2">
          <div>
            <p className="text-[11px] font-bold uppercase text-gray-500">Protect this</p>
          ...
          <div>
            <p className="text-[11px] font-bold uppercase text-gray-500">Avoid this</p>
            <h2 className="mt-5 text-3xl font-black leading-tight text-white sm:text-4xl">
      ...
      <section className="border-y border-white/10 bg-zinc-950 px-6 py-24 sm:px-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-14 lg:grid-cols-[0.72fr_1fr]">
          <div>
            <p className="text-[11px] font-bold uppercase text-brand-red">Bring list</p>
            <h2 className="mt-5 text-4xl font-black leading-tight text-white sm:text-5xl">
      ...
      <section className="border-t border-white/10 bg-black px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href={guide.primaryPage} className="rounded-full bg-white px-6 py-3 text-sm font-bold text-black transition-transform hover:scale-[1.03]">
              View matching studio
            </Link>
            <Link href="/book/" prefetch={false} className="rounded-full border border-white/15 px-6 py-3 text-sm font-bold text-white transition-colors hover:border-white/40">
              Book a session
            </Link>
          </div>
        </div>
