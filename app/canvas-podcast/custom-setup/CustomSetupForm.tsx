  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <button
        ...
        className="inline-flex items-center gap-3 rounded bg-brand-red px-8 py-4 text-sm font-bold tracking-wide text-white transition-colors hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60"
      >
