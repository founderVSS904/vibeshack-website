...
const studios: PodcastSet[] = [
  {
    ...
    img: '/studio-setups/the-executive/two-office-chairs-desk.webp',
    thumb: '/studio-setups/the-executive/two-office-chairs-desk.webp',
    series: 'Walnut Series',
    category: 'podcast',
    line: 'A walnut set with desk layouts for 1 or 2, or 3 armchairs without a desk.',
    ...
    specs: ['Desk or armchair layouts', 'Wood slat wall', PODCAST_CAMERA_LABEL],
    position: 'center 48%',
  },
  {
    id: 'wing',
